...
function init(){
	...
	cleanBtn.addEventListener('click', onClearAll);
...
function persist() {
	try{
		...
		console.warn('Не удвалось сщхранить в localStorage.', e);
	}
}
...
function createCardElement(card){
	...
	delBtn.setAttribute('aira-label','Удалить');
	...
	badge.innerHTML = 'Двойной клик по тексту - начать редактирование.Enter - сохранить.Esc - удалить.';
...
function startEdit(cardEl){
	...
	cardEl.setAttribute('aira-busy', 'true')
}
...
lastSnapshot = null;
cardEl.removeAttribute('aira-busy');
render();
}
function genId(){
